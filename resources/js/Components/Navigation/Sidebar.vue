...
const isCollapsed = computed(() => {
    return props.collapsed !== undefined ? props.collapsed : uiStore.sidebarCollapsed;
});

const isMobileOpen = computed(() => uiStore.sidebarMobileOpen);
    ...
    >
        ...
        <div class="brand-link px-4 py-3.5 border-b border-white/10 flex items-center justify-between shrink-0 h-16">
            <div class="flex items-center min-w-0 overflow-hidden">
                ...
                />
                <div v-show="!isCollapsed" class="ml-3 truncate">
        ...
        <div v-show="!isCollapsed" class="px-3 pt-3 pb-1 shrink-0">
            <div class="relative">
        ...
        <div class="p-3 border-t border-white/10 shrink-0 bg-[#16182E]/80 backdrop-blur-xs space-y-2">
            ...
            <div 
                ...
                :class="isCollapsed ? 'justify-center' : 'justify-between hover:bg-white/5'"
            >
                <div class="flex items-center min-w-0">
                    <div 
                        ...
                        :title="isCollapsed ? `${authUser.name} (${authUser.role})` : undefined"
                    >
                        {{ authUser.name.charAt(0).toUpperCase() }}
                    </div>
                    <div v-show="!isCollapsed" class="ml-2.5 truncate">
            ...
            <button
                ...
                :class="isCollapsed ? 'justify-center px-0' : 'justify-between px-3 text-xs'"
                :title="isCollapsed ? 'Expandir barra lateral' : 'Colapsar barra lateral'"
                @click="handleToggleCollapse"
            >
                <span v-show="!isCollapsed" class="font-medium text-[11px] text-slate-300">
                    Colapsar menú
                </span>
                <component 
