...
// UGEL → Institución → Docente encadenados por AJAX (solo alcance General, que
// es donde el Blade los usaba); en UGEL/Director el filtro de docente es texto
// libre, igual que en la vista original.
...
<template>
    <AppLayout>
        <Head title="Producción de Textos Infantiles - Consulta" />
        ...
        <BaseTable
            ...
            :export-filename="`produccion_textos_infantiles_${scope}`"
            :loading="loading"
            @search="handleSearch"
