    ...
    >
        <div class="space-y-4">
            ...
            <div>
                ...
                <div v-if="isEditing && produccion.enlace && !selectedFileName" class="mb-2 p-2.5 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-between">
