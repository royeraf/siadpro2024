                ...
                <div class="card" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <h4 class="card-title" id="name">Servicio: {{ $dat->proveedorServicio }}</h4>
                        </div>
                        ...
                        <em><center><a href="{{ url('/interInstitucion/'.$dat->id.'/ver_mas') }}"><h5>Ver mas --></h5></a></center></em>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    <a href="{{ url('/interInstitucion/'.$dat->id.'/edit') }}" class="btn btn-primary btn-lg">Editar</a>
                                </div>
                                <div class="col-6">
                                    <form action="{{  route ('interInstitucion.destroy',$dat->id)}}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <input class="btn btn-danger btn-lg" type="submit" onclick="return confirm('¿Quieres Eliminar esta Informacion?')" value="Borrar">
                                    </form>
                                </div>
                            </div>
                        </div>
