...
@section('content_header')
    <x-section-heading icon="book-open">Listado de Biblioteca en el Aula para Especialista DRE</x-section-heading>
@stop
...
<x-table-pagination id="tabla-informes-general" :paginator="$informes" />
