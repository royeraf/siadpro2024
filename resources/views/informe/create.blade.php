    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-orange card-outline">
                <div class="card-header"><h1 align="center">Crear Nueva Biblioteca en el Aula</h1></div>
                ...
                <div class="card-body">
                    <form method="POST" action="/informes" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombreInforme" type="text" class="form-control @error('nombreInforme') is-invalid @enderror" required name="nombreInforme" autofocus>
