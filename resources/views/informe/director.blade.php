...
@section('title', 'Biblioteca de Aula (Director)')
...
@section('content_header')
    <h1 class="m-0 text-dark"><i data-lucide="book-open" class="w-6 h-6 mr-2 inline-block align-text-bottom"></i>Listado de Biblioteca en el Aula Director</h1>
@stop
    ...
    <div class="col-12">
        <div class="stats-card">
            ...
            <div class="stats-info">
                <span class="stats-number" id="tabla-informes-director-total">{{ number_format($informes->total()) }}</span>
...
<x-table-base id="tabla-informes-director"
              :perPage="10"
              :exportable="true"
              :searchable="true"
              exportFilename="biblioteca_aula_director"
              :serverPaginated="true"
              :totalServerRecords="$informes->total()"
              :fromServer="$informes->firstItem() ?? 0"
              :toServer="$informes->lastItem() ?? 0"
              :filterAction="route('informes.director')">
    <x-slot name="filters">
...
<div id="tabla-informes-director-pagination" class="mt-3 flex justify-center sm:justify-end">
