...
@section('content_header')
    <x-section-heading icon="book-open">Listado de Biblioteca en el Aula Director</x-section-heading>
@stop
...
<x-table-pagination id="tabla-informes-director" :paginator="$informes" />
