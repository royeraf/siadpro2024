    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-yellow card-outline">
                <div class="card-header"><h1 align="center">Crear nueva acci贸n de sensibilizaci贸n</h1></div>

                <div class="card-body">
                    <form method="POST" action="/accions" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label for="nombreAccion" class="col-md-4 col-form-label text-md-right">{{ __('Nombre de la Acci贸n') }}</label>
