...
@section('title', 'Acción de Sensibilización (General)')
    ...
    <div class="col-12">
        <div class="stats-card">
            ...
            <div class="stats-info">
                <span class="stats-number" id="tabla-acciones-general-total">{{ number_format($accions->total()) }}</span>
                <span class="stats-title">Total de Acciones de Sensibilización ({{ $anio }})</span>
            </div>
        </div>
    </div>
</div>
...
<x-table-base id="tabla-acciones-general"
              ...
              :exportable="true"
              :searchable="true"
              exportFilename="acciones_sensibilizacion_general"
              :exportUrl="route('exportAccionsGeneral', request()->all())"
              :serverPaginated="true"
              :totalServerRecords="$accions->total()"
              :fromServer="$accions->firstItem() ?? 0"
              :toServer="$accions->lastItem() ?? 0"
              :filterAction="route('accions.view')">
    <x-slot name="filters">
        ...
        @if($showFullFilters)
            ...
            <x-table-filter name="instituciones" label="Institución" icon="school" placeholder="Nombre de la institución" />
        @endif
    </x-slot>
    <x-slot name="header">
        <tr>
