    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-cyan card-outline">
                <div class="card-header"><h1 align="center">Espacios de lectura en el hogar</h1></div>

                <div class="card-body">
                    <form method="POST" action="/plans" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label for="nombrePlan" class="col-md-4 col-form-label text-md-right">{{ __('Tipo de texto') }}</label>

                            <div class="col-md-6">
                                <input id="nombrePlan" type="text" class="form-control @error('nombrePlan') is-invalid @enderror" required name="nombrePlan" autofocus>
