...
@section('content_header')
    <x-section-heading icon="book-heart">Listado de Espacio de Lectura en el Hogar Director</x-section-heading>
@stop
...
<x-table-pagination id="tabla-plans-director" :paginator="$plans" />
