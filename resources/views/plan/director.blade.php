...
@section('title', 'Espacio de Lectura en el Hogar (Director)')
...
@section('content_header')
    <h1 class="m-0 text-dark"><i data-lucide="book-heart" class="w-6 h-6 mr-2 inline-block align-text-bottom"></i>Listado de Espacio de Lectura en el Hogar Director</h1>
@stop
    ...
    <div class="col-12">
        <div class="stats-card">
            ...
            <div class="stats-info">
                <span class="stats-number" id="tabla-plans-director-total">{{ number_format($plans->total()) }}</span>
...
<x-table-base id="tabla-plans-director"
              :perPage="10"
              :exportable="true"
              :searchable="true"
              exportFilename="espacio_lectura_hogar_director"
              :serverPaginated="true"
              :totalServerRecords="$plans->total()"
              :fromServer="$plans->firstItem() ?? 0"
              :toServer="$plans->lastItem() ?? 0"
              :filterAction="route('plans.director')">
    <x-slot name="filters">
...
<div id="tabla-plans-director-pagination" class="mt-3 flex justify-center sm:justify-end">
    @if ($plans->hasPages())
