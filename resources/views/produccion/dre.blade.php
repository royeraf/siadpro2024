...
<table id="produccions" class="table table-striped table-bordered shadow-lg mt-4 display nowrap" style="width:100%">
                    ...
                    <tbody >
                     ...
                     <div class="form-inline">
                        <p>Total de producciones Subidos: {{$produccions->total()}}</p> <br>
                        {{$produccions->appends(request()->only(['texto', 'instituciones', 'docentes', 'ugels', 'nivel', 'year']))->links()}}
                     </div>                    
@stop
...
var buscarInstitucionesProduccionRoute = "{{ route('buscarInstitucionesProduccion') }}";
var buscarDocenteporInstitucionProRoute = "{{ route('buscarDocenteporInstitucion-pro') }}";
var buscadordocenteRoute = "{{ route('buscarDocentesProduccion') }}";
var buscarProduccionGeneralRoute = "{{ route('buscarProduccionGeneral') }}";
...
$(document).ready(function() {
    ...
    // Búsqueda de instituciones en tiempo real
    $('#institucion').on('input', function() {
        ...
        $.ajax({
            url: buscarInstitucionesProduccionRoute,
            method: 'GET',
            data: {
                ugel: selectedUgel,
                term: searchTerm,
    ...
    // Búsqueda de docentes en tiempo real
