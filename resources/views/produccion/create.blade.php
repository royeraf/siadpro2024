    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-green card-outline">
                <div class="card-header"><h1 align="center">Crear Nueva Producción de Textos Infantiles</h1></div>

                <div class="card-body">
                    <form method="POST" action="/produccions" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label for="nombreProduccion" class="col-md-4 col-form-label text-md-right">{{ __('Tipo de la Producción') }}</label>

                            <div class="col-md-6">
                                <input id="nombreProduccion" type="text" class="form-control @error('nombreProduccion') is-invalid @enderror" required name="nombreProduccion" Placeholder="(Rima, cuento, adivinanza, poesía, etc.)" autofocus>
