...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <x-section-heading icon="notebook-pen">Listado de Producción de Textos Infantiles</x-section-heading>
...
<x-table-pagination id="tabla-produccions" :paginator="$produccions" />
