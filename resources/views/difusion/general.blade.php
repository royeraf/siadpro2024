    ...
    <div class="col-12">
        <div class="stats-card">
            ...
            <div class="stats-info">
                <span class="stats-number" id="tabla-difusiones-general-total">{{ number_format($accions->total()) }}</span>
                <span class="stats-title">Total de Acciones de Difusión ({{ $anio }})</span>
            </div>
        </div>
    </div>
</div>
...
<div id="tabla-difusiones-general-pagination" class="mt-3 flex justify-end">
    @if ($accions->hasPages())
