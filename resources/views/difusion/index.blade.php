...
@section('content_header')
    <x-page-header icon="radio" title="Acción de Difusión" color="blue" />
@stop
...
<div class="flex justify-start mb-3">
    @can('difusions.create')
    <x-create-button :href="route('difusions.create')">Nueva Difusión</x-create-button>
    @endcan
</div>
...
<x-table-pagination id="tabla-difusiones" :paginator="$accions" />
