                        ...
                        <tbody>
                            ...
                            @foreach ($accions as $accion)
                                <tr>
                                    ...
                                    <td align="center"><a href="#" data-file-viewer data-src="{{ route('visor.stream', ['path' => $accion->enlace]) }}" data-name="{{ basename($accion->enlace) }}" data-download="{{ route('difusions.download', $accion->id) }}" title="Ver documento"><i class='{{$accion->documento}}' style='font-size:24px;color:{{$accion->color}}' ></i></a></td>
                                    <td>{{$accion->name}}</td>
                                    <td>{{$accion->cargo}}</td>
