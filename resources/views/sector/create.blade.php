    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-red card-outline">
                <div class="card-header"><h1 align="center">REGISTRAR INFORMACION</h1></div>

                <div class="card-body">
                    <form method="POST" action="/sectores" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label for="nombreSector" class="col-md-4 col-form-label text-md-right">{{ __('Nombre sectores del aula') }}</label>

                            <div class="col-md-6">
                                <input id="nombreSector" type="text" class="form-control @error('nombreSector') is-invalid @enderror" required name="nombreSector" autofocus>
